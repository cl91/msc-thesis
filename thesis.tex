...
\begin{equation}
  g_{ij} = \left( \begin{array}{cc}
    ...
    \end{array}\right)
\end{equation}
where $\phi = \arccos \langle e_1,e_2\rangle$, where $\langle v, w\rangle$ is defined to be the inner product of vector $v$ and $w$, and the second fundamental form takes
\begin{equation}
