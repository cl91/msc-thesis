...
\begin{equation}
  x^3 = f(x^1, x^2)
\end{equation}
where $(x^1,x^2)\in U$ for some open set $U\subset \mathbb{R}^2$. The following so-called Codazzi-Mainardi equation describes the compatiblilty condition encoding the fact that the higher order differentials of $f$ are independent of the order of differentiation:
