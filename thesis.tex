...
\begin{figure}\centering
  ...
  \caption{The full stability map of the $\phi^4$ oscillons. [TOP] Theoretical map with $d\in(-1,1)$. [DOWN] Numerical map $E_{\rm fini}/E_{\rm init}$ generated from the same algorithm in Chapter \ref{general}.}\label{stabilityfull}
\end{figure}
