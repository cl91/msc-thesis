...
In the large-amplitude limit, where one of $\omega_i$ is very close to 0, we see exotic

\chapter{General Potential and Dimensionality: Numerical Studies}

We assess the existence of qualitatively similar solutions to eqs.~\ref{twoscale}--\ref{denomg}  for the axion monodromy  and sixth-order potentials in 1, 2 and 3 dimensions, and the sine-Gordon in 2 and 3 dimensions. The relevant potentials are:
%
\begin{eqnarray}
