...
\section{Note on the Numerical Methods Used in the Project}


\section{Summary of New Results}
The main results of this Thesis are the exact analytic oscillon solution of the 1D sine-Gordon equation with two independent oscillation time scales, or the ``two-scale'' solution, and the extension of this exact result to general potentials and dimensionalities, in particular, the 3D axion-monodromy potential.
...
\chapter{Motivating the Two-scale Solution}\label{exactsol}
