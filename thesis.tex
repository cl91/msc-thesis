...
\begin{equation}
  c_1^2+ c_2^2 = 0
\end{equation}
These relations are obtained from the general expression for the 1-scale oscillon (Eq.~(9.2) in \cite{:/content/aip/journal/jmp/51/12/10.1063/1.3520596}) and setting both the $\sin$ term on the numerator and the constant term on the denominator to 0.
