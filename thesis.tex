...
\begin{tikzcd}
  ...
  0\arrow{ur}{a_1}\arrow{dr}{a_2}&&{\rm 2-soliton}&\\
...
By doing a series of B\"acklund transformations one can derive the two-scale solution (``double breather''), through the following Bianchi diagram:
\[
\begin{tikzcd}
