...
\begin{figure}\centering
  \includegraphics[width=0.6\textwidth]{plot/full-phi4-theory.pdf}\\\vskip12pt
  \includegraphics[width=0.7\textwidth]{plot/energy-ratio-phi4-1d.png}
  \caption{The full stability map of the 1D $\phi^4$ oscillons. [TOP] Theoretical map with $d\in(-1,1)$.\qquad [DOWN] Numerical map $E_{\rm fini}/E_{\rm init}$ generated from the same algorithm in Chapter \ref{general}.}\label{stabilityfull}
\end{figure}
